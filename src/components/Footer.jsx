...
const Footer = () => {
  return (
    <footer className="z-10 bg-white py-20">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10">
              <img src={logo} alt="logo" className="max-w-40 mb-5" />

              <p className="mb-7 text-base text-gray-500">
                Empowering learners worldwide with flexible online courses to grow skills, build portfolios, and achieve career goals.
              ...
              <div className="flex items-center gap-4">
                ...
                <a
                  ...
                  href="#"
                  className="text-gray-400 hover:text-[#0c448d] transition duration-300 cursor-pointer"
                >
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10">
              ...
              <ul>
                {["Home", "Courses", "Events", "Blog"].map((item, index) => (
                  <li key={index}>
                    <a
                      href="#"
                      className="block mb-2 text-base text-gray-500 hover:text-[#0c448d] transition"
                    >
                      {item}
                    </a>
                  </li>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10">
              ...
              <ul>
                {["Design", "Development", "Marketing", "SEO Design"].map((item, index) => (
                  <li key={index}>
                    <a
                      href="#"
                      className="block mb-2 text-base text-gray-500 hover:text-[#0c448d] transition"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10">
              ...
              <ul className="text-gray-500">
                <li className="mb-3">
                  <p>
                    <span className="font-semibold text-gray-800">Phone:</span> +884-9273-3867
                  </p>
                </li>

                <li className="mb-3">
                  <p>
                    <span className="font-semibold text-gray-800">Email:</span> skillrise@gmail.com
                  </p>
                </li>

                <li>
                  <p>
                    <span className="font-semibold text-gray-800">Address:</span> Random Road<br />
                    USA
                  </p>
                </li>
              </ul>
